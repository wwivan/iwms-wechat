      ...
      <van-list v-model="loading"
        ...
        <div v-for="(item, index) in records"
          ...
          <div class="content">
            ...
            <div class="confirm">
              <div style="width:0.8rem;height:0.33rem;background:linear-gradient(135deg, #4181ff, #2360ef);text-align:center;line-height:0.33rem;color:white;border-radius:0.03rem;font-size:0.15rem"
