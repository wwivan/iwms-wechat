        ...
        >
          <div class="header">
            ...
            <span
              ...
              >{{
                item.stockOutItem.stockOut == undefined
                  ? ""
                  : item.stockOutItem.stockOut.orderNo
              }}</span
            >
          </div>
          <div class="content">
            <div>
              <div>
                物料名称:
                {{
                  item.stockOutItem == undefined
                    ? ""
                    : item.stockOutItem.materielSku.name
                }}
              </div>
              ...
              <div>
                货位:{{
                  item.cell == undefined
                    ? ""
                    : item.cell.pallet.wareArea.wareHouse.code
                }}仓库
                {{
                  item.cell == undefined ? "" : item.cell.pallet.wareArea.code
                }}库区
